...
return [
    ...
    'descriptions' => [
        ...
        'canvas-designer' => '核心画布设计技能，涵盖项目管理、多媒体原理、AI 图像生成、网页图片搜索与设计标记处理。任何画布设计任务都应加载。重要：当用户消息包含 [@design_canvas_project:...] 或 [@design_marker:...] 提及，或用户希望在画布项目上生成视频/动画/片段时，必须在执行任何操作前优先加载此技能。',
