...
return [
    ...
    'tag_structure_invalid' => 'Slides template tag structure is invalid',
    'tag_group_cannot_bind' => 'Slides template cannot bind tag groups',
    ...
    'tag_code_regex' => 'Tag code can contain only lowercase letters, numbers, hyphens, and underscores',
    'tag_parent_id_integer' => 'Tag parent ID must be an integer',
    'tag_parent_id_min' => 'Tag parent ID cannot be less than 0',
    'tag_node_type_in' => 'Tag node type must be group or tag',
    'tag_usage_type_in' => 'Tag usage type must be filter, detail, or operational',
    ...
    'tag_description_array' => 'Tag description must be an array',
    'tag_description_zh_cn_max' => 'Tag Chinese description cannot exceed 500 characters',
    'tag_description_en_us_max' => 'Tag English description cannot exceed 500 characters',
    'tag_aliases_array' => 'Tag aliases must be an array',
    'tag_is_visible_boolean' => 'Tag visibility must be a boolean',
