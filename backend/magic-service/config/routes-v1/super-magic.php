...
use App\Interfaces\SuperMagic\File\Facade\AudioMarkerApi;
use App\Interfaces\SuperMagic\File\Facade\AudioProjectApi;
use App\Interfaces\SuperMagic\File\Facade\FileApi;
use App\Interfaces\SuperMagic\File\Facade\FileEditingApi;
use App\Interfaces\SuperMagic\Message\Facade\MessageApi;
use App\Interfaces\SuperMagic\Project\Facade\MicroAppProjectApi;
use App\Interfaces\SuperMagic\Project\Facade\ProjectApi;
use App\Interfaces\SuperMagic\Project\Facade\ProjectInvitationLinkApi;
use App\Interfaces\SuperMagic\Project\Facade\ProjectMemberApi;
use App\Interfaces\SuperMagic\Task\Facade\SandboxApi;
use App\Interfaces\SuperMagic\Task\Facade\SandboxPreWarmApi;
use App\Interfaces\SuperMagic\Task\Facade\SuperAgentMemoryApi;
use App\Interfaces\SuperMagic\Task\Facade\TaskApi;
use App\Interfaces\SuperMagic\Topic\Facade\TopicApi;
use App\Interfaces\SuperMagic\Workspace\Facade\WorkspaceApi;
...
Router::addGroup(
    ...
    static function () {
        ...
        Router::addGroup('/sandbox', static function () {
            ...
            // 取消沙箱保活
            Router::post('/keep-alive/cancel', [SandboxPreWarmApi::class, 'cancelKeepAlive']);
        });
