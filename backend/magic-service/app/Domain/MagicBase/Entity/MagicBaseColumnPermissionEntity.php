...
class MagicBaseColumnPermissionEntity extends AbstractEntity
{
    ...
    public function setColumnId(null|int|string $value): void
    {
        $this->columnId = is_numeric($value) ? (int) $value : null;
    }
