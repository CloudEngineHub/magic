...
use App\Domain\SuperMagic\Message\Entity\OpenMessageScheduleEntity;
use App\Domain\SuperMagic\Message\Entity\ValueObject\Query\OpenMessageScheduleQuery;
...
use App\Interfaces\SuperMagic\Message\DTO\Response\OpenMessageScheduleDetailDTO;
use App\Interfaces\SuperMagic\Message\DTO\Response\OpenMessageScheduleListItemDTO;
...
class OpenMessageScheduleAppService extends AbstractAppService
{
    ...
    public function create(MagicUserAuthorization $authorization, OpenMessageScheduleEntity $entity): array
    {
        ...
        $entity->setMessageContent(
            $this->buildFullMessageContent(
                (string) $entity->getMessageContentText(),
                $this->buildModelFromProviderModelId((string) $entity->getModelId(), $dataIsolation),
                $entity->getTopicPattern(),
    ...
    protected function buildFullMessageContent(
        string $userText,
        array $model,
