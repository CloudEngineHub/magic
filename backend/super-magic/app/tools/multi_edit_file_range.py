    ...
    async def execute(self, tool_context: ToolContext, params: MultiEditFileRangeParams) -> ToolResult:
        ...
        try:
            ...
            if is_html_app_memory_path(file_path):
                return ToolResult.error("HTML-APP.md is managed by update_html_app_memory. Use that tool instead of multi_edit_file_range so MagicBase data model records are not overwritten.")
