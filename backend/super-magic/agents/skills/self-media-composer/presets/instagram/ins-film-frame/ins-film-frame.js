/**
 * ins-film-frame.js
 * Instagram Film Frame ECharts presets.
 * CSS quick reference: .iff-card, .iff-cover, .iff-content, .iff-header, .iff-section-label, .iff-data-card, .iff-list-row, .iff-quote-block, .iff-compare-grid, .iff-note.
 */
(function (global) {
  "use strict";
  var T = {
  ...
  presets["ins-film-frame-bar"] = function (params) {
  ...
  presets["ins-film-frame-line"] = function (params) {
  ...
  presets["ins-film-frame-donut"] = function (params) {
  ...
  function get(key, params) {
    if (!presets[key]) {
      console.warn("[InsFilmFramePresets] preset not found:", key);
      return {};
    }
    return presets[key](params || {});
  }
  var api = { get: get, add: add, tokens: T };
  global.InsFilmFramePresets = api;
