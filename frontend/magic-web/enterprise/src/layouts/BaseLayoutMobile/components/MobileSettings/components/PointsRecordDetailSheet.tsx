...
} from "@/layouts/BaseLayoutMobile/components/MobileSettings//pointsRecordDisplay"
import type { PointsRecordItem } from "@/layouts/BaseLayoutMobile/components/MobileSettings/types"
import { MobileSettingsSheetContainer } from "@/layouts/BaseLayoutMobile/components/MobileSettings/components//SheetContainer"
...
export function MobileSettingsPointsRecordDetailSheet(props: {
	...
	const showFeedback = !isPrivateDeployment()
