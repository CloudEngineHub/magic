...
type MicroAppPublishValidationError =
	| "projectNameRequired"
	| "projectNameTooLong"
	| "passwordInvalid"
...
export default function MicroAppPublishDialog({
	...
	return (
		<MagicModal
			...
			destroyOnClose
		>
			{/* A minmax grid row constrains ScrollArea while allowing short dialogs to fit content. */}
			<div
				className="grid max-h-[80dvh] min-h-0 grid-rows-[minmax(0,1fr)_auto_auto] gap-4"
							...
							<div className="mt-4">
								<div className="flex items-center justify-between gap-3">
									...
									<div className="flex items-center gap-2">
										...
										{formState.coverFileKey !== undefined ||
										formState.coverUrl ? (
											<Button
												type="button"
												variant="ghost"
											...
											>
												<div className="flex items-center justify-between gap-3">
													<div className="min-w-0">
														<p className="text-sm font-medium text-foreground">
															{t(
																"microAppPage.publish.quickShareTitle",
															)}
														</p>
													...
													<div className="flex shrink-0 items-center gap-2">
														...
														>
															<Copy className="size-3.5" />
															{t(
																"microAppPage.publish.copyShareText",
															)}
														</Button>
													</div>
												</div>
					...
					<div className="flex items-center gap-3">
						...
						<div className="flex items-center gap-2">
							<Button
								...
								disabled={
									saving || unpublishing || coverUploading || coverUploadError
								}
							>
								{t("common.cancel")}
							</Button>
