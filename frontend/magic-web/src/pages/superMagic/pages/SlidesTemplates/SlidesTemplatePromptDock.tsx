...
const SLIDES_TEMPLATE_EDITOR_CONTAINER_CLASS_NAME = [
	...
	"[&_[data-testid=super-message-editor-toolbar-right]_button[data-active=true]]:!gap-1",
	"[&_[data-testid=super-message-editor-toolbar-right]_button[data-active=true]]:!px-1.5",
	"[&_[data-testid=super-message-editor-toolbar-right]_button[data-active=true]_[data-slot=badge]]:!border-white/[0.12]",
	"[&_[data-testid=super-message-editor-toolbar-right]_button[data-active=true]_[data-slot=badge]]:!bg-white/[0.14]",
	"[&_[data-testid=super-message-editor-toolbar-right]_button[data-active=true]_[data-slot=badge]]:!text-white/[0.92]",
	"[&_[data-testid=super-message-editor-toolbar-right]_button[data-active=true]:hover_[data-slot=badge]]:!bg-white/[0.2]",
	...
	"[&_[data-testid=internet-search-button][aria-pressed=true]:hover]:!border-white/[0.46]",
