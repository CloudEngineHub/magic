...
// Builds the minimal mixed template/filter panel that matches the PPT HomePage header layout.
...
// Renders the real panel after module mocks are registered for this focused test.
async function renderMixedHeaderPanel() {
	const { default: FieldConfigPanel } = await import("../FieldConfigPanel")
