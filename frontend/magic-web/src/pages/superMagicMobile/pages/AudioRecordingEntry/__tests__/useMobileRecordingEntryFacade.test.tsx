...
vi.mock("../apis/recording-settings-api", () => recordingTopicModelApiMock)

vi.mock("../utils/summary-model-list", () => summaryModelListMock)
...
vi.mock("@/pages/superMagic/components/MessageEditor/hooks/useFileUpload", async () => {
	const actual = await vi.importActual<
		typeof import("@/pages/superMagic/components/MessageEditor/hooks/useFileUpload")
	>("@/pages/superMagic/components/MessageEditor/hooks/useFileUpload")
