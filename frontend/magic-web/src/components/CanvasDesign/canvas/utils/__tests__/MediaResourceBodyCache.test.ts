...
import { MediaResourceBodyCache, type MediaResourceBodyCacheEntry } from "../MediaResourceBodyCache"

function createEntry(overrides: Partial<MediaResourceBodyCacheEntry> = {}): MediaResourceBodyCacheEntry {
	return {
		sourceUrl: null,
