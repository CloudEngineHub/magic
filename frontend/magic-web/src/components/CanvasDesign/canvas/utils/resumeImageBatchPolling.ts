import { ElementTypeEnum, type ImageElement as ImageElementData } from "../types"
...
import { collectElementsByType } from "./utils"
...
function shouldResumeBatchPolling(element: ImageElementData): boolean {
	...
	if (
		...
		!shouldContinueGenerationPolling(element.status)
	) {
		return false
	}
