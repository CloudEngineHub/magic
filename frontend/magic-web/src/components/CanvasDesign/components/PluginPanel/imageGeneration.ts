...
import { ElementTypeEnum, type ImageElement, type LayerElement } from "../../canvas/types"
import {
	normalizePathLocal,
	pathsReferToSameResource,
	stripCurrentDirectoryPrefix,
} from "../../canvas/utils/pathUtils"
import type { Rect } from "../../canvas/utils/utils"
import { resolvePluginSourceElementId, type PluginSourceElementMap } from "./pluginSourceElements"
